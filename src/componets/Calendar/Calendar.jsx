    ...
    return (
        <R.Calendar className="pop-new-card__calendar">
            ...
            <R.CalendarBlock>
                ...
                <R.CalendarContent>
                    <R.CalendarDaysNames>
                        <R.CalendarDayName>пн</R.CalendarDayName>
                        <R.CalendarDayName>вт</R.CalendarDayName>
                        <R.CalendarDayName>ср</R.CalendarDayName>
                        <R.CalendarDayName>чт</R.CalendarDayName>
                        <R.CalendarDayName>пт</R.CalendarDayName>
                        <R.CalendarDayName className="-weekend-">сб</R.CalendarDayName>
                        <R.CalendarDayName className="-weekend-">вс</R.CalendarDayName>
                    </R.CalendarDaysNames>
                    <R.CalendarCells>
